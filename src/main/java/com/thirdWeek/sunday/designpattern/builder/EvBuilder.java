package com.thirdWeek.sunday.designpattern.builder;
...
public class EvBuilder {
    ...
    public static EvBuilder startHavuzluEvBuild(String il, String ilce, String mahalle, int binaYili, int balkonSayisi,boolean hasHavuz){
        ...
        evBuilder.mahalle = mahalle;
        evBuilder.binaYili = binaYili;
        evBuilder.balkonSayisi = balkonSayisi;
        evBuilder.hasHavuz = hasHavuz;
